...
PYBIND11_MODULE(roboball2d_interface_py,m)
{
  ...
  pybind11::class_<roboball2d_interface::WorldState>(m,"WorldState")
    ...
    .def_readwrite("ball_hits_floor_position",&WorldState::ball_hits_floor_position)
  ...
  pybind11::class_<roboball2d_interface::MirrorAction>(m,"MirrorAction")
    ...
    .def("set_torques",&MirrorAction::set_mirroring_information)
    .def("get_torques",&MirrorAction::get_mirroring_information);
