...
#define MIRRORING_TYPE 0
#define TORQUES_TYPE 1
#define BALL_GUN_TYPE 2
#define VISION_TYPE 3
#define FIVE_BALLS_MIRRORING_TYPE 4
#define FIVE_BALLS_BALL_GUN_TYPE 5
...
namespace roboball2d_interface
{
    ...
    static void add_world_state(pybind11::module &m,
